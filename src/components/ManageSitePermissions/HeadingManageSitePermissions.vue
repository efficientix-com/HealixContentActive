<template>
    <div id="HeadingManageSitesPermission">
      <div class="d-flex">
        <div>
          <h1 class="blue-text">
            <font-awesome-icon icon="fa-solid fa-location-arrow" size="1x" />
            Manage Sites | Site Permission
          </h1>
        </div>
        <!-- <div class="ml-auto">
          <b-form-select
  ...
  <script>
  export default {
    name: "HeadingManageSitesPermission",
    data:function(){
      return{
