<template>
  <div id="DatatableManageSites">
    <!-- filters -->
    <b-row>
      <b-col>
        <label class="mr-sm-2" for="select-payer">Site</label>
        <b-form-select
          id="select-payer"
          class="form-select"
      ...
      <b-col>
        <label class="mr-sm-2" for="select-payer">Report Name</label>
        <b-form-select
          id="select-payer"
          class="form-select"
      ...
      <b-col>
        <label class="mr-sm-2" for="select-payer">Report Type</label>
        <b-form-select
          id="select-payer"
          class="form-select"
    ...
    <b-row class="mt-4">
      <b-col>
        <table class="table mt-3 px-2" id="datatable_Manage_Sites"></table>
      </b-col>
    </b-row>
  </div>
</template>
...
import { data_test_financial_reporting } from "./data_test_financial_reporting";

export default {
  name: "DatatableManageSites",
  data: function () {
    return {
      datatable: null,
      selectedPhysician: "",
  ...
  mounted() {
    this.datatable = new DataTable("#datatable_Manage_Sites", {
      responsive: true,
      data: data_test_financial_reporting(),
      columnDefs: [
            ...
            return `
              <div class="d-flex justify-content-center">
                <div class="form-check">
                  ...
                  <div class="option-item-btn btn btn-light text-center mr-1">
