    ...
    <b-row>
      ...
      >
        <b-img
          ...
          width="70px"
          height="70px"
          src="https://firebasestorage.googleapis.com/v0/b/bloona-55051.appspot.com/o/Magdiel%20Jimenez_FreeBug.png?alt=media&token=62a8cb52-cb99-4f0e-9088-086adc9cac3e"
          rounded="circle"
          alt="Circle image"
        ></b-img>
      </b-col>
      <b-col class="d-flex justify-content-center mt-2" md="12" sm="12">
        <h4 class="userName mb-0">Magdiel Elienai</h4>
      </b-col>
      <b-col class="d-flex justify-content-center py-0 my-0" md="12" sm="12">
        <p class="userRole">DM USER</p>
      </b-col>
    </b-row>
    <b-row
